...
public class Teclado extends JPanel implements  ActionListener {
    ...
    private final Color COR_CINZA_ESCURO = new Color(72,71,72);
    private final Color COR_CINZA_CLARO = new Color(101,97,103);
    private final Color COR_LARANJA = new Color(242,161,62);

    public Teclado(){
        //242,161,62 laranja
        //101,97,103 cinza claro
        //72,71,72 cinza Escuro
